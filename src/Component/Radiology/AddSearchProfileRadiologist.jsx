...
function AddSearchProfileRadiologist({ refresh }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!form.name || form.name.trim() === "") {
        errors.push(t("radiologyCenterNameRequired", language));
      }
      ...
      if (!files.idOrPassportCopy) {
        errors.push(t("idOrPassportCopyRequired", language));
      }
      ...
      if (response.status === 200 || response.status === 201) {
        setSnackbar({
          open: true,
          message: t("radiologyCenterProfileCreatedSuccessfully", language),
          severity: "success",
        });
      ...
      console.error("❌ Error creating radiologist search profile:", err);
            ...
            <Stack direction="row" alignItems="center" spacing={2} mb={2}>
              ...
              <Box>
                <Typography variant="h4" fontWeight="700" sx={{ mb: 0.5 }}>
                  {t("addRadiologyCenterProfile", language)}
                </Typography>
                <Typography variant="body1" sx={{ opacity: 0.9 }}>
                  {t("createYourRadiologyCenterProfile", language)}
                </Typography>
              </Box>
            </Stack>
          </Paper>
                ...
                <Stack spacing={3}>
                  ...
                  <Box>
                    ...
                    <Stack spacing={2}>
                      ...
                      >
                        {t("openMapAndSelectLocation", language)}
                      </Button>
                  ...
                  <Box>
                    ...
                    <TextField
                      ...
                      multiline
                      rows={4}
                      placeholder={t("describeYourRadiologyCenter", language)}
                      sx={fieldSx}
                      InputProps={{
                        startAdornment: (
                    ...
                    <Stack spacing={2}>
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" sx={{ color: "#666", mt: 0.5, display: "block" }}>
                          {t("licenseToPracticeMedicine", language)} (PDF, DOC, JPG, PNG)
                        </Typography>
                      </Box>
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" sx={{ color: "#666", mt: 0.5, display: "block" }}>
                          {t("universityMedicalDegreeCertificate", language)} (PDF, DOC, JPG, PNG)
                        </Typography>
                      </Box>
                      ...
                      <Box>
                        ...
                        <Typography variant="caption" sx={{ color: "#666", mt: 0.5, display: "block" }}>
                          {t("copyOfNationalIdOrPassport", language)} (PDF, DOC, JPG, PNG)
                        </Typography>
                      </Box>
                      ...
                      <Box>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", mb: 1 }}>
                          <Typography variant="subtitle2" sx={{ fontWeight: 600, color: "#556B2F" }}>
                            🏢 Radiology Center Registration - تسجيل المركز
                          </Typography>
                          <Typography variant="caption" sx={{ fontWeight: 600, color: "#666" }}>
                            {t("optional", language)}
                          </Typography>
                        ...
                        <label htmlFor="clinicRegistration" style={{ width: "100%" }}>
                          <Button
                            ...
                            startIcon={<CloudUploadIcon />}
                          >
                            {fileNames.clinicRegistration ? `✅ ${fileNames.clinicRegistration}` : "🏢 Radiology Registration (Optional)"}
                          </Button>
                        </label>
                        <Typography variant="caption" sx={{ color: "#666", mt: 0.5, display: "block" }}>
                          {t("officialRadiologyCenterRegistration", language)} (PDF, DOC, JPG, PNG)
                        </Typography>
                      </Box>
                    </Stack>
                  </Box>
                  ...
                  >
                    {t("profilePendingApprovalInfo", language)}
                  </Typography>
                </Stack>
              </form>
            </CardContent>
...
export default AddSearchProfileRadiologist;
