// src/Component/CoordinationAdmin/Claims/ClaimsManage.jsx
...
const [selectedImage, setSelectedImage] = useState(null);
  ...
  const handleReturnForReview = async () => {
    ...
    try {
      ...
      setSnackbar({
        open: true,
        message: t("failedReturnClaim", language),
        severity: "error",
      });
    } finally {
      setIsSubmitting(false);
    ...
    <Box sx={{ display: "flex" }} dir={isRTL ? "rtl" : "ltr"}>
      ...
      >
        ...
        <Box sx={{ p: 4 }}>
          ...
          >
            <Box>
              <Typography variant="h4" fontWeight="bold" sx={{ color: "#0D3B66" }}>
...
>
  {isSubmitting ? <CircularProgress size={20} color="inherit" /> : t("approveFinal", language)}
</Button>
...
>
  ...
  <DialogActions>
    <Button onClick={() => setOpenRejectDialog(false)} disabled={isSubmitting}>{t("cancel", language)}</Button>
    ...
    <Button
      ...
      disabled={isSubmitting}
    >
      {isSubmitting ? <CircularProgress size={20} color="inherit" /> : t("returnForReview", language)}
    </Button>
  </DialogActions>
</Dialog>
{/* Final Reject Dialog */}
<Dialog open={openFinalRejectDialog} onClose={() => setOpenFinalRejectDialog(false)}>
  ...
  <DialogActions>
    <Button onClick={() => setOpenFinalRejectDialog(false)} disabled={isSubmitting}>{t("cancel", language)}</Button>
    <Button onClick={handleRejectFinal} color="error" disabled={isSubmitting}>
      {isSubmitting ? <CircularProgress size={20} color="inherit" /> : t("reject", language)}
    </Button>
  </DialogActions>
</Dialog>
